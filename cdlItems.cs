...
namespace FenixAutomat
{
    ...
    public partial class cdlItems
    {
        public cdlItems()
        {
            this.CommunicationMessagesReceptionConfirmationItems = new HashSet<CommunicationMessagesReceptionConfirmationItems>();
        }
        ...
        public virtual ICollection<CommunicationMessagesReceptionConfirmationItems> CommunicationMessagesReceptionConfirmationItems { get; set; }
    }
}
